...
@onready var _raycast3d:RayCast3D = $Head/RayCast3D
@onready var _hold_pos:Node3D = $Head/HoldPosition
...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("left_click"):
		if _raycast3d.get_collider():
			held_object = _raycast3d.get_collider()
